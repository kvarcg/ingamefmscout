...
namespace FMScout.CustomControls
{
    public class NumericUpDown : Control
    {
        ...
        private static void OnMinimumChanged(DependencyObject element, DependencyPropertyChangedEventArgs args)
        {
            ...
            RoutedPropertyChangedEventArgs<decimal> e = new RoutedPropertyChangedEventArgs<decimal>(
               oldValue, newValue, MinimumChangedEvent);
        ...
        /// </summary>
        /// <param name="args">Arguments associated with the MinimumChanged event.</param>
        protected virtual void OnMinimumChanged(RoutedPropertyChangedEventArgs<decimal> args)
        {
            RaiseEvent(args);
        }
        #endregion
        ...
        private static void OnMaximumChanged(DependencyObject element, DependencyPropertyChangedEventArgs args)
        {
            ...
            RoutedPropertyChangedEventArgs<decimal> e = new RoutedPropertyChangedEventArgs<decimal>(
               oldValue, newValue, MaximumChangedEvent);
        ...
        /// </summary>
        /// <param name="args">Arguments associated with the MaximumChanged event.</param>
        protected virtual void OnMaximumChanged(RoutedPropertyChangedEventArgs<decimal> args)
        {
            RaiseEvent(args);
        }
        #endregion
        ...
        /// <summary>
        /// Identifies the MinimumChanged routed event.
        /// </summary>
        public static readonly RoutedEvent MinimumChangedEvent = EventManager.RegisterRoutedEvent(
            "MinimumChanged", RoutingStrategy.Bubble,
            typeof(RoutedPropertyChangedEventHandler<decimal>), typeof(NumericUpDown));

        /// <summary>
        /// Occurs when the Minimum property changes.
        /// </summary>
        public event RoutedPropertyChangedEventHandler<decimal> MinimumChanged
        {
        ...
        /// <summary>
        /// Identifies the MaximumChanged routed event.
        /// </summary>
        public static readonly RoutedEvent MaximumChangedEvent = EventManager.RegisterRoutedEvent(
            "MaximumChanged", RoutingStrategy.Bubble,
            typeof(RoutedPropertyChangedEventHandler<decimal>), typeof(NumericUpDown));

        /// <summary>
        /// Occurs when the Maximum property changes.
        /// </summary>
        public event RoutedPropertyChangedEventHandler<decimal> MaximumChanged
        {
        ...
        private const decimal DefaultMinimum = -1,
