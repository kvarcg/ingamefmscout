...
Football Manager 9.1.0 & 9.2.0 (maybe 9.0.0)

NOTE:
- To see all our own players leave sale value to zero, it will also search for players with sale value -1 (your own for example)
